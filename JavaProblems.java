...
abstract class JavaProblems {
    abstract double calculateArea();
}

class Circle extends JavaProblems {
    double radius;
...
class Square extends JavaProblems {
    double side;
...
public class Main {
    public static void main(String[] args) {
        JavaProblems circle = new Circle(5);
        JavaProblems square = new Square(4);
